...
class DeleteGroupRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, datasource, group_name, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, datasource, group_name, *args, **kwargs):  # noqa: E501
        """DeleteGroupRequest - a model defined in OpenAPI
