...
class ConnectorType(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str): The source from which document content was pulled, e.g. an API crawl or browser history., must be one of ["API_CRAWL", "BROWSER_CRAWL", "BROWSER_HISTORY", "BUILTIN", "FEDERATED_SEARCH", "PUSH_API", "WEB_CRAWL", "NATIVE_HISTORY", ]  # noqa: E501

        Keyword Args:
            value (str): The source from which document content was pulled, e.g. an API crawl or browser history., must be one of ["API_CRAWL", "BROWSER_CRAWL", "BROWSER_HISTORY", "BUILTIN", "FEDERATED_SEARCH", "PUSH_API", "WEB_CRAWL", "NATIVE_HISTORY", ]  # noqa: E501
