...
class CheckDocumentAccessRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, datasource, object_type, doc_id, user_email, *args, **kwargs):  # noqa: E501
        """CheckDocumentAccessRequest - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, datasource, object_type, doc_id, user_email, *args, **kwargs):  # noqa: E501
        """CheckDocumentAccessRequest - a model defined in OpenAPI
