...
class TeamMember(ModelNormal):
    ...
    def _from_openapi_data(cls, email, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            relationship (str): The member's relationship to the team, an enum of `MEMBER`, `MANAGER`, `LEAD`, `POINT_OF_CONTACT`, `OTHER`. [optional] if omitted the server will use the default value of "MEMBER"  # noqa: E501
            join_date (date): The member's start date. [optional]  # noqa: E501
        """
