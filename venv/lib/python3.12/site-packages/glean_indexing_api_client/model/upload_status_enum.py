...
class UploadStatusEnum(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """UploadStatusEnum - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str): Upload status, enum of NOT_UPLOADED, UPLOADED, STATUS_UNKNOWN., must be one of ["UPLOADED", "NOT_UPLOADED", "STATUS_UNKNOWN", ]  # noqa: E501

        Keyword Args:
            value (str): Upload status, enum of NOT_UPLOADED, UPLOADED, STATUS_UNKNOWN., must be one of ["UPLOADED", "NOT_UPLOADED", "STATUS_UNKNOWN", ]  # noqa: E501
