...
class TeamInfoDefinition(ModelNormal):
    ...
    def _from_openapi_data(cls, id, name, members, *args, **kwargs):  # noqa: E501
        """TeamInfoDefinition - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            description (str): The description of this team. [optional]  # noqa: E501
            ...
            department (str): An organizational unit where everyone has a similar task, e.g. `Engineering`.. [optional]  # noqa: E501
            photo_url (str): A link to the team's photo. [optional]  # noqa: E501
            external_link (str): A link to an external team page. If set, team results will link to it. . [optional]  # noqa: E501
            emails ([TeamEmail]): The emails of the team. [optional]  # noqa: E501
            datasource_profiles ([DatasourceProfile]): The datasource profiles of the team, e.g. `Slack`,`Github`.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, name, members, *args, **kwargs):  # noqa: E501
        """TeamInfoDefinition - a model defined in OpenAPI
