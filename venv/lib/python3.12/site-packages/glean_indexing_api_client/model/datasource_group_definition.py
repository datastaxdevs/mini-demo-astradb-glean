...
class DatasourceGroupDefinition(ModelNormal):
    ...
    def _from_openapi_data(cls, name, *args, **kwargs):  # noqa: E501
        """DatasourceGroupDefinition - a model defined in OpenAPI

        Args:
            name (str): name of the group. Should be unique among all groups for the datasource, and cannot have spaces.
