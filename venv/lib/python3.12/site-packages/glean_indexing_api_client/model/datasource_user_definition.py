...
class DatasourceUserDefinition(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, email, name, *args, **kwargs):  # noqa: E501
        """DatasourceUserDefinition - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            user_id (str): To be supplied if the user id in the datasource is not the email. [optional]  # noqa: E501
            is_active (bool): set to false if the user is a former employee or a bot. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, email, name, *args, **kwargs):  # noqa: E501
        """DatasourceUserDefinition - a model defined in OpenAPI
