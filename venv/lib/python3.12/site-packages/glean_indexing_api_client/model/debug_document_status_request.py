...
class DebugDocumentStatusRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, object_type, doc_id, *args, **kwargs):  # noqa: E501
        """DebugDocumentStatusRequest - a model defined in OpenAPI

        Args:
            object_type (str): Object type of the document to get the status for
            doc_id (str): Document ID within the datasource to get the status for
    ...
    @convert_js_args_to_python_args
    def __init__(self, object_type, doc_id, *args, **kwargs):  # noqa: E501
        """DebugDocumentStatusRequest - a model defined in OpenAPI
