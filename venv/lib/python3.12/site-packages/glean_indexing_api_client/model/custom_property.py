...
class CustomProperty(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            value (bool, date, datetime, dict, float, int, list, str, none_type): Must either be a string or an array of strings. An integer, boolean, etc. is not valid. When OpenAPI Generator supports `oneOf`, we can semantically enforce this.. [optional]  # noqa: E501
        """
