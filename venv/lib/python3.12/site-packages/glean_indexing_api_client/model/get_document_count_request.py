...
class GetDocumentCountRequest(ModelNormal):
    ...
    def _from_openapi_data(cls, datasource, *args, **kwargs):  # noqa: E501
        """GetDocumentCountRequest - a model defined in OpenAPI

        Args:
            datasource (str): Datasource name for which document count is needed.
