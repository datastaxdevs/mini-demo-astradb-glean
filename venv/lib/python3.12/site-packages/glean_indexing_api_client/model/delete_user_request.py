...
class DeleteUserRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, datasource, email, *args, **kwargs):  # noqa: E501
        """DeleteUserRequest - a model defined in OpenAPI

        Args:
            datasource (str): The datasource for which the user is removed
    ...
    @convert_js_args_to_python_args
    def __init__(self, datasource, email, *args, **kwargs):  # noqa: E501
        """DeleteUserRequest - a model defined in OpenAPI
