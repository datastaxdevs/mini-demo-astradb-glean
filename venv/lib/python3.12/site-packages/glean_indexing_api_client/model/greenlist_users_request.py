...
class GreenlistUsersRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, datasource, emails, *args, **kwargs):  # noqa: E501
        """GreenlistUsersRequest - a model defined in OpenAPI

        Args:
            datasource (str): Datasource which needs to be made visible to users specified in the `emails` field.
            emails ([str]): The emails of the beta users
    ...
    @convert_js_args_to_python_args
    def __init__(self, datasource, emails, *args, **kwargs):  # noqa: E501
        """GreenlistUsersRequest - a model defined in OpenAPI
