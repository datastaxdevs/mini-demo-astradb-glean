...
class AdditionalFieldDefinition(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """AdditionalFieldDefinition - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            key (str): Key to reference this field, e.g. \"languages\". Note that the key should be all lowercase alphabetic characters with no numbers, spaces, hyphens or underscores.. [optional]  # noqa: E501
