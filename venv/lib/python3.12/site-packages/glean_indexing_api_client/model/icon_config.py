...
class IconConfig(ModelNormal):
    ...
    def openapi_types():
        ...
        """
        return {
            'generated_background_color_key': (str,),  # noqa: E501
    ...
    attribute_map = {
        'generated_background_color_key': 'generatedBackgroundColorKey',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """IconConfig - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            generated_background_color_key (str): [optional]  # noqa: E501
            ...
            masked (bool): Whether the icon should be masked based on current theme.. [optional]  # noqa: E501
            name (str): The name of the icon if applicable, e.g. the glyph name for `IconType.GLYPH` icons.. [optional]  # noqa: E501
            url (str): The URL to an image to be displayed if applicable, e.g. the URL for `iconType.URL` icons.. [optional]  # noqa: E501
        """
