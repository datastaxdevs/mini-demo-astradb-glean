...
class DeleteDocumentRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, datasource, object_type, id, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, datasource, object_type, id, *args, **kwargs):  # noqa: E501
        """DeleteDocumentRequest - a model defined in OpenAPI
