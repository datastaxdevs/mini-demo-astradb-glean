...
class AuthenticationApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.rotatetoken_post_endpoint = _Endpoint(
            settings={
                'response_type': (RotateTokenResponse,),
                'auth': [
                    'BearerAuth'
                ],
                'endpoint_path': '/rotatetoken',
                'operation_id': 'rotatetoken_post',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
    ...
    def rotatetoken_post(
        ...
        **kwargs
        ...
        >>> thread = api.rotatetoken_post(async_req=True)
        >>> result = thread.get()
        ...
        return self.rotatetoken_post_endpoint.call_with_http_info(**kwargs)
